...
const CartItem = (props) => {
    const { id, imageBurger, name, types, sizes, price, quantityItemInCart, deleteGroupCartItem } = props;

    const removeItemInCart = () => {
        deleteGroupCartItem(name, types, price);
    };
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-remove" onClick={ removeItemInCart } >
