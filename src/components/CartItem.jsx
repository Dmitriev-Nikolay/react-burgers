    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <div className="button button--outline button--circle cart__item-count-minus" onClick={ handleRemoveItemInGroup } >
            ...
            <div className="cart__item-remove" title="Удалить бургеры?" onClick={ handleRemoveItemsGroup } >
